...
#ifndef DATA_STRUCTURES_2_STREAMINGDBA1_H
#define DATA_STRUCTURES_2_STREAMINGDBA1_H
...
private:
    AVLTree<std::shared_ptr<User>, UserById> users;
    AVLTree<std::shared_ptr<Group>, GroupById> groups;
    AVLTree<std::shared_ptr<Movie>, MovieById> moviesById;
    AVLTree<std::shared_ptr<Movie>, MovieByRating> moviesByRatings;
    AVLTree<std::shared_ptr<Movie>, MovieByRating> dramaMovies;
    AVLTree<std::shared_ptr<Movie>, MovieByRating> comedyMovies;
    AVLTree<std::shared_ptr<Movie>, MovieByRating> actionMovies;
    AVLTree<std::shared_ptr<Movie>, MovieByRating> fantasyMovies;
    int totalDrama;
    int totalComedy;
    int totalAction;
    int totalFantasy;
...
#endif //DATA_STRUCTURES_2_STREAMINGDBA1_H
